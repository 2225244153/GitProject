...
---@field public OutputVolume number @Deprecated -- The output volume of the submix. Applied after submix effects and analysis are performed.
---@field public WetLevel number @Deprecated -- The wet level of the submix. Applied after submix effects and analysis are performed.
---@field public DryLevel number @Deprecated -- The dry level of the submix. Applied before submix effects and analysis are performed.

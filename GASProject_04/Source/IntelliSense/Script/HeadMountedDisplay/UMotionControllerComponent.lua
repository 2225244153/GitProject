...
---@field public bDisplayDeviceModel boolean
---@field public DisplayModelSource string
---@field public CustomDisplayMesh UStaticMesh
---@field public DisplayMeshMaterialOverrides TArray<UMaterialInterface>
---@field public DisplayComponent UPrimitiveComponent

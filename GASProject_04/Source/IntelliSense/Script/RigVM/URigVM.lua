...
---@field public WorkMemoryStorageObject URigVMMemoryStorage
---@field public LiteralMemoryStorageObject URigVMMemoryStorage
---@field public DebugMemoryStorageObject URigVMMemoryStorage
...
---@field private ParametersNameMap TMap<string, integer>
---@field private DeferredVMToCopy URigVM
local URigVM = {}

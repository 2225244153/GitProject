...
---@field public Observer TScriptInterface<UMovieSceneSequencePlayerObserver> @Obeserver interface used for controlling whether the effects of this sequence can be seen even when it is playing back.

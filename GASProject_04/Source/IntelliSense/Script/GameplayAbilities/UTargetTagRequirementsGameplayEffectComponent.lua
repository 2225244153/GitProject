...
---@field public ApplicationTagRequirements FGameplayTagRequirements @Tag requirements for this GameplayEffect to be applied to a target. This is pass/fail at the time of application. If fail, this GE fails to apply.

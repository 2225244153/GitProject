...
---@field public BlueprintBrush TSubclassOf<ALandscapeBlueprintBrushBase> @Blueprint Brush Tool
...
---@field public ImportExportMode ELandscapeImportExportMode @Import Loaded or All Landscape Regions
...
---@field public BrushRadius number @The radius of the sculpt brush, in unreal units
---@field public PaintBrushRadius number @The radius of the paint brush, in unreal units
...
---@field public PaintBrushFalloff number @The falloff at the edge of the point brush, as a fraction of the brush's size. 0 = no falloff, 1 = all falloff

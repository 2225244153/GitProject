...
---@field public NumTilesX integer @Number of tiles in the X direction. If 0, then there are no tiles.
---@field public NumTilesY integer @Number of tiles in the Y direction. If 0, then there are no tiles.

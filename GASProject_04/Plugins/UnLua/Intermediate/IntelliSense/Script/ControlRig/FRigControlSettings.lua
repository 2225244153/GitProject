...
---@field public ControlEnum UEnum @If the control is 4transient and only visible in the control rig editor
...
---@field public bUsePreferredRotationOrder boolean @Whether to use a specfied rotation order or just use the default FRotator order and conversion functions

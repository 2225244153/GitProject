...
---@field public LibraryName string @* Optionally provide the namespace of the shape library to use. * This is only useful if you have multiple shape libraries and you * want to override a specific one. * If this is empty and ReplaceExisting is checked we'll replace the first * shape library on this rig.
---@field public ReplaceExisting boolean @* If true we'll try to replace an existing library.

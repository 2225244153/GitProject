...
function UControlRigBlueprintFactory.CreateNewControlRigAsset(InDesiredPackagePath) end

---Create a new control rig asset within the contents space of the project
---based on a skeletal mesh or skeleton object.
---@param InSelectedObject UObject
---@return UControlRigBlueprint
function UControlRigBlueprintFactory.CreateControlRigFromSkeletalMeshOrSkeleton(InSelectedObject) end

...
---@param TimeUnit ESequenceTimeUnit @[opt] 
---@return boolean
...
---@return boolean
function UControlRigSequencerEditorLibrary.LoadAnimSequenceIntoControlRigSection(MovieSceneSection, AnimSequence, SkelMeshComp, InStartFrame, TimeUnit, bKeyReduce, Tolerance) end
...
function UControlRigSequencerEditorLibrary.FindOrCreateControlRigTrack(World, LevelSequence, ControlRigClass, InBinding) end
...
---@return boolean
function UControlRigSequencerEditorLibrary.BakeToControlRig(World, LevelSequence, ControlRigClass, ExportOptions, bReduceKeys, Tolerance, Binding) end

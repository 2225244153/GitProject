...
---@field public CombineMethod ECombineCurvesMethod @Note: Combining and offsetting curves only works when curves are flattened; curves will be left separate and non-offset if FlattenMethod is DoNotFlatten

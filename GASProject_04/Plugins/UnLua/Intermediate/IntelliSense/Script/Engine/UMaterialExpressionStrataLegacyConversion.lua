---@class UMaterialExpressionStrataLegacyConversion : UMaterialExpressionStrataBSDF
...
---@field public ConvertedStrataMaterialInfo FStrataMaterialInfo @Store converted material models.
local UMaterialExpressionStrataLegacyConversion = {}

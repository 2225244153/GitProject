...
---@field protected GroupName string @The group name (NAME_None if it is not part of any group)
---@field protected GroupRole integer @The role this player can assume within the group (ignored if GroupIndex is INDEX_NONE)
---@field protected Method EAnimSyncMethod @How synchronization is determined

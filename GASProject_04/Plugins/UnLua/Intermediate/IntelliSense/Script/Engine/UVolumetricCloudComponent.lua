...
---@field public AerialPespectiveRayleighScatteringFadeDistance number @Specify the distance over which the Rayleigh scattering will linearly ramp up to ful leffect. (kilometers)
...
---@field public AerialPespectiveMieScatteringFadeDistance number @Specify the distance over which the Rayleigh scattering will linearly ramp up to ful leffect. (kilometers)

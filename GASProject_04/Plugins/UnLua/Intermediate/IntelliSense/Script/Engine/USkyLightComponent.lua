...
---@field public bShowIlluminanceMeter boolean @When enabled, visualize on screen the sky cube map as well as the integrate half hemisphere of luminance, together with the sky illuminance contribution at the position of the skylight component. It also show the atmospheric directional light illuminance post SkyAtmosphere transmittance at the position on the skylight component.

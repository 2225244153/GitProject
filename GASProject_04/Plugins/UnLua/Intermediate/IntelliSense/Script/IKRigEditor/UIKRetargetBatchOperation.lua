...
---@param Prefix string
---@param Suffix string
---@param bRemapReferencedAssets boolean @[opt] 
---@return TArray_FAssetData_
function UIKRetargetBatchOperation.DuplicateAndRetarget(AssetsToRetarget, SourceMesh, TargetMesh, IKRetargetAsset, Search, Replace, Prefix, Suffix, bRemapReferencedAssets) end

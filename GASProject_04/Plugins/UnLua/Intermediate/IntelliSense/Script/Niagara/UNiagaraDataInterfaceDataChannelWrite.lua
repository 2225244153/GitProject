...
---@field public bPublishToCPU boolean @Whether the data generated by this DI should be published to the world CPUSim data channel. This is required for CPU emitters in other Niagara Systems to read this data.
---@field public bPublishToGPU boolean @Whether the data generated by this DI should be published to a world data channel. This is required to allow GPU emitters in other Niagara Systems to read this data.
...
---@field public Channel UNiagaraDataChannelAsset @When writing externally, the channel to use.

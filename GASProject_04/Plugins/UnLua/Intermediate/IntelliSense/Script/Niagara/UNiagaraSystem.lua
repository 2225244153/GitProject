...
---@field public TemplateSpecification ENiagaraScriptTemplateSpecification @If this system is a regular system, a template or a behavior example.
...
---@field public bCompileForEdit boolean @When enabled we compile for the edit path, which can result in slower system performance but faster editor responsiveness.
...
---@field public bDisableExperimentalVM boolean @If true, disables experimental VM, if available

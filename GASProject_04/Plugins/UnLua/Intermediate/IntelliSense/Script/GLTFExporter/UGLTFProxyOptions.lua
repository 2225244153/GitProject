...
---@field public DefaultMaterialBakeSize EGLTFMaterialBakeSizePOT @Default size of the baked out texture (containing the material input). Can be overridden by material- and input-specific bake settings, see GLTFMaterialExportOptions.

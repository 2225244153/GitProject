...
---@field protected ActiveGameplayCues FActiveGameplayCueContainer @List of all active gameplay cues, including ones applied manually
---@field protected MinimalReplicationGameplayCues FActiveGameplayCueContainer @Replicated gameplaycues when in minimal replication mode. These are cues that would come normally come from ActiveGameplayEffects

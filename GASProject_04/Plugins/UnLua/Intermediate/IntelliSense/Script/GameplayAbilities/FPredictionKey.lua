...
---@field public PredictiveConnection UPackageMap
---@field public Current integer @The unique ID of this prediction key
---@field public Base integer @If non 0, the prediction key this was created from
---@field public bIsStale boolean @If stale, this key cannot be used for more prediction

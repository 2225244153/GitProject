...
---@field private PostProcessInstances TSet<FGuid> @A set of object binding IDs that relate to post process instances (must be a child of USkeletalMeshComponent)
